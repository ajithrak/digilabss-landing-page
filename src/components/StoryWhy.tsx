...
export default function StoryWhy() {
  return (
    <section className="relative overflow-hidden px-6 py-32 sm:py-40 lg:px-12">
      <div className="mx-auto grid max-w-6xl items-center gap-16 sm:grid-cols-[1.1fr_0.9fr] lg:gap-24">
        <Reveal>
